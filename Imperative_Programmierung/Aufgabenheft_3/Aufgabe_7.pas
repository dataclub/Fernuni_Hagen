...
{
    Die Alternative A ist korrekt.
zu
A) Das Programm ist korrekt.
zu
B)
Das Programm ist falsch. Die Prozedur Ausgabe wird innerhalb der Prozedur Kuerzen
verwendet und ist daher lokal vereinbart. Ihr Aufruf im Hauptprogramm ist deswegen
unmöglich.
zu
C)
Das Programm liefert ein falsches Ergebnis. In der Prozedur Kuerzen werden inZaehler
und inNenner als Wertparameter deklariert. Nach der Abarbeitung der Prozedure sind
die Werte von inZaehler und inNenner nicht geändert.
}